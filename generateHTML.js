   ...
   <head>
      ...
      <div class="container">
          <div class="photo-header">
            ...
            <h1>Hi! </br> My name is ${answers.name}</h1>
            <h3>currently @ </h3>
            <div class="links-nav">
                <h4 class="nav-link location"> location : ${answers.location}</h4>
                <h4 class="nav-link location"> github: ${answers.github}</h4>
                <h4 class="nav-link location"> blog : ${answers.blog}</h4>
          </div>
          </div>
          
          <main>
            <h1 class="col container">${answers.github}</h1>
            <div class="container">
                <div class="row">
                    <div class="col card">
                        <h2>Public Reposipories</h2>
                        <h3>${answers.github}</h3>
                    </div>
                    <div class="col card">
                      <h2>Followers</h2>
                      <h3>${answers.github}</h3>
